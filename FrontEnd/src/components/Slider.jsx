                        ...
                        sliderImages && sliderImages.map((slides, index) => {
                            return (
                                <SwiperSlide key={index}>
                                    <Link className='relative flex h-[400px] w-full' to={'/abc'}>
                                        ...
                                        <div className='flex items-center gap-4 md:h-[70%] h-1/2 w-full mt-auto px-2 md:px-4 py-4'>
                                            <div className='z-20 aspect-[5/7] h-full  overflow-hidden rounded-sm shadow'>
                                                <img src={slides.url} alt="" className='object-fill w-full h-full' />
                                            </div>
                                            <div className='z-20 flex flex-col h-full flex-1'>
                                                <div className='flex-1 flex flex-col gap-5 mb-5 sm:mb-2 text-white'>
                                                    <h1 className='text-3xl font-amaranth font-bold'>{slides.title}</h1>
                                                    <p className='line-clamp-3 hidden sm:block max-w-[700px]'>{slides.desc}</p>
                                                </div>
